    ...
    <main>
      ...
      <section className="section-text-img">
        ...
        <div className="section-image">
          <Image className="img-small" src="/img7.jpg" alt="ocean drawing" width={400} height={500}></Image>
        </div>
      </section>

      <section className="section-text-img different">
        <div className="section-image">
          <Image className="img-small" src="/img8.jpg" alt="ocean drawing" width={400} height={500}></Image>
        </div>
      ...
      <section className="section-text-img">
        ...
        <div className="section-image">
          <Image className="img-small" src="/img3.jpg" alt="ocean drawing" width={400} height={500}></Image>
        </div>
      </section>
